...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK_DH] = LAYOUT(
            KC_BSPC,      KC_SCLN,      KC_Y,         KC_U,         KC_L,         KC_J,               KC_B,         KC_P,         KC_F,         KC_W,         KC_Q,         KC_TAB,
            KC_QUOT,      KC_O,         KC_I,         KC_E,         KC_N,         KC_K,               KC_G,         LT(_QUICK_ACCESS_RIGHT, KC_T), LT(_RIGHT_SPECIAL, KC_S),KC_R,         KC_A,         KC_ESC,
